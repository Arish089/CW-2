...
export default function SecondLastFooter() {
  return (
    <>
      <div className="last-sec-div1" style={{ textAlign:"center", padding: "1rem 2rem" }}>
        <Heading textAlign="center" mb={10}>
          Stay Healthy with Tata 1mg: Your Favourite Online Pharmacy and
          Healthcare Platform
        </Heading>
        <Heading textAlign="center" fontSize='24' my={4}>We Bring Care to Health.</Heading>
        ...
        <Heading textAlign="center" fontSize='24' my={4}>Tata 1mg: Your Favourite Online Pharmacy!</Heading>
        <Text>
        ...
        <Heading textAlign="center" fontSize='24' my={4}>The Feathers in Our Cap</Heading>
        <Text textAlign="center">
        ...
        <Heading textAlign="center" fontSize='24' my={4}>The Services We Offer</Heading>
        <Text textAlign="center">
        ...
        <Text textAlign="center">Stay Healthy!</Text>
      </div>
    </>
  );
}